...
public class PlanGroupRequestDTO {
	...
	public static class Create {
		...
		private final LinkedList<PlanDetailRequestDTO.Create> planDetails;
	}
	...
	public class Update {
		...
		@Schema(title = "세부 일정 LinkedList", description = "수정할 세부 일정의 LinkedList입니다.")
		private final LinkedList<PlanDetailRequestDTO.Update> planDetails;
